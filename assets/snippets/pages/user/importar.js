!(function (n, t) {
  ...
  var n = {
    ...
    x = function (n) {
      for (var t in n)
        C.isValidParameter(t) || i('Unknown parameter "' + t + '"'),
          C.isDeprecatedParameter(t) &&
            p(
              'The parameter "' +
                t +
    ...
    k = function (n) {
      ...
      var t = void 0,
        ...
        s =
          "string" == typeof n.target
            ...
            : n.target;
      (t = e && s && e.parentNode !== s.parentNode ? B(n) : e || B(n)),
        n.width &&
          (t.style.width =
      ...
      for (
        ...
        c[p].style.backgroundColor = r;
      var w = E(),
        u = j(),
        d = q().querySelector("#" + o.content),
        f = D(),
        m = R(),
        b = N(),
        g = H(),
      ...
      if (
        ...
        "string" == typeof n.backdrop
          ...
          : n.backdrop ||
            F([document.documentElement, document.body], o["no-backdrop"]),
        n.html
          ? X(n.html, d)
          : n.text
          ? ((d.textContent = n.text), nn(d))
          : tn(d),
        n.position in o
          ? F(w, o[n.position])
          : (i('The "position" parameter is not valid, defaulting to "center"'),
            F(w, o.center)),
      ...
      "function" == typeof n.animation && (n.animation = n.animation.call()),
        n.showCloseButton
          ? (g.setAttribute("aria-label", n.closeButtonAriaLabel), nn(g))
          : tn(g),
        (t.className = o.popup),
        n.toast
          ? (F([document.documentElement, document.body], o["toast-shown"]),
            F(t, o.toast))
          : F(t, o.modal),
        n.customClass && F(t, n.customClass);
      var k = O(),
        y = parseInt(
      ...
      n.progressSteps && n.progressSteps.length
        ? (nn(k),
          ...
          n.progressSteps.forEach(function (t, e) {
            ...
            if (
              (F(a, o.progresscircle),
              (a.innerHTML = t),
              e === y && F(a, o.activeprogressstep),
              k.appendChild(a),
      ...
      if (n.type) {
        ...
        var z = t.querySelector("." + o.icon + "." + a[n.type]);
        nn(z), n.animation && F(z, "swal2-animate-" + n.type + "-icon");
      }
      var Y = V();
      if (
        (n.imageUrl
          ? (Y.setAttribute("src", n.imageUrl),
            Y.setAttribute("alt", n.imageAlt),
            nn(Y),
            n.imageWidth
              ? Y.setAttribute("width", n.imageWidth)
              : Y.removeAttribute("width"),
            n.imageHeight
              ? Y.setAttribute("height", n.imageHeight)
              : Y.removeAttribute("height"),
            (Y.className = o.image),
            n.imageClass && F(Y, n.imageClass))
          : tn(Y),
        n.showCancelButton ? (b.style.display = "inline-block") : tn(b),
        n.showConfirmButton ? an(m, "display") : tn(m),
        n.showConfirmButton || n.showCancelButton ? nn(f) : tn(f),
        ...
        J([m, b], o.styled),
          ...
          (b.style.backgroundColor = b.style.borderLeftColor = b.style.borderRightColor =
            "");
      X(n.footer, h),
        !0 === n.animation ? J(t, o.noanimation) : F(t, o.noanimation),
    ...
    y = function () {
      null === S.previousBodyPadding &&
        ...
        (document.body.style.paddingRight = ln() + "px"));
    },
    v = function () {
      if (
    ...
    C = function n() {
      ...
      if ("undefined" != typeof window) {
        if (
          ...
          return l("SweetAlert2 expects at least 1 attribute!"), !1;
        var s = d({}, m);
        switch (u(e[0])) {
          case "string":
        ...
        return new Promise(function (t, e) {
          ...
          var d = function (n) {
            ...
            switch (n) {
              ...
              case "radio":
                return (
                  b.querySelector("." + o.radio + " input:checked") ||
                  b.querySelector("." + o.radio + " input:first-child")
                );
              case "range":
            ...
            var m = function (t) {
              ...
              x = function (t) {
                var e = t || window.event,
                  ...
                  a = R(),
                  r = N(),
                  l = a && (a === o || a.contains(o)),
                  p = r && (r === o || r.contains(o));
                switch (e.type) {
                  case "click":
                    if (l && n.isVisible())
                      ...
                      p &&
                        n.isVisible() &&
                        (n.disableButtons(), i(n.DismissReason.cancel));
                }
              },
              C = b.querySelectorAll("button"),
              A = 0;
            A < C.length;
            A++
          )
          ...
          if (
            ...
            b.onclick = function (t) {
              t.target !== b ||
                ...
                s.showCancelButton ||
                (s.allowOutsideClick &&
                  (n.closePopup(s.onClose), i(n.DismissReason.backdrop)));
            };
          else {
            var B = !1;
            (b.onmousedown = function () {
              ...
              (p.onmousedown = function () {
                b.onmouseup = function (n) {
                  (b.onmouseup = void 0),
                    (n.target === b || b.contains(n.target)) && (B = !0);
                };
              }),
              (p.onclick = function (t) {
                B
                  ? (B = !1)
                  : t.target === p &&
                    w(s.allowOutsideClick) &&
                    i(n.DismissReason.backdrop);
              });
          }
          var P = q(),
            T = D(),
          ...
          s.toast && h && ((window.onkeydown = g), (h = !1)),
            s.toast ||
              h ||
              ((g = window.onkeydown),
              (h = !0),
                ...
                if ("Enter" !== e.key || e.isComposing)
                  if ("Tab" === e.key) {
                    ...
                    [
                      ...
                      ? document.activeElement === z && on(X)
                        ? X.focus()
                        : document.activeElement === X && on(z) && z.focus()
                      : ("Escape" !== e.key && "Esc" !== e.key) ||
                        !0 !== w(s.allowEscapeKey) ||
                        i(n.DismissReason.esc);
                else if (e.target === d()) {
            ...
            (n.hideLoading = n.disableLoading = function () {
              s.showConfirmButton || (tn(z), s.showCancelButton || tn(D())),
                J([b, T], o.loading),
            ...
            (n.enableButtons = function () {
              (z.disabled = !1), (X.disabled = !1);
            }),
            (n.disableButtons = function () {
              (z.disabled = !0), (X.disabled = !0);
            }),
            ...
            n.hideLoading(),
            n.resetValidationError(),
            s.input && F(document.body, o["has-input"]);
          for (
            var Q = [
                "input",
                "file",
            ...
            var rn = o[Q[an]],
              ln = G(P, rn);
            if ((en = d(Q[an]))) {
              for (var cn in en.attributes)
                if (en.attributes.hasOwnProperty(cn)) {
                  var pn = en.attributes[cn].name;
                  "type" !== pn && "value" !== pn && en.removeAttribute(pn);
                }
              for (var wn in s.inputAttributes)
                en.setAttribute(wn, s.inputAttributes[wn]);
            }
          ...
          switch (s.input) {
            ...
            case "tel":
            case "url":
              ((en = G(P, o.input)).value = s.inputValue),
                (en.placeholder = s.inputPlaceholder),
                (en.type = s.input),
                nn(en);
              break;
            case "file":
              ((en = G(P, o.file)).placeholder = s.inputPlaceholder),
                (en.type = s.input),
                nn(en);
              break;
            case "range":
              var hn = G(P, o.range),
                xn = hn.querySelector("input"),
                kn = hn.querySelector("output");
              (xn.value = s.inputValue),
                (xn.type = s.input),
                (kn.value = s.inputValue),
                nn(hn);
              break;
            case "select":
              var yn = G(P, o.select);
              if (((yn.innerHTML = ""), s.inputPlaceholder)) {
                ...
                (vn.innerHTML = s.inputPlaceholder),
                  (vn.value = ""),
                  (vn.disabled = !0),
                  (vn.selected = !0),
                  yn.appendChild(vn);
              ...
              gn = function (n) {
                ...
                try {
                  for (
                    ...
                    (w.value = c),
                      (w.innerHTML = p),
                      s.inputValue.toString() === c.toString() &&
                        (w.selected = !0),
                      yn.appendChild(w);
                  }
                } catch (n) {
            ...
            case "radio":
                  ...
                  try {
                    for (
                      ...
                      (u.type = "radio"),
                        (u.name = o.radio),
                        (u.value = p),
                        s.inputValue.toString() === p.toString() &&
                          (u.checked = !0),
                        (d.innerHTML = w),
              ...
              break;
            case "checkbox":
              var Sn = G(P, o.checkbox),
                An = d("checkbox");
              (An.type = "checkbox"),
                (An.value = 1),
                (An.id = o.checkbox),
                (An.checked = Boolean(s.inputValue));
              var Bn = Sn.getElementsByTagName("span");
              Bn.length && Sn.removeChild(Bn[0]),
                ((Bn = document.createElement("span")).innerHTML =
                  s.inputPlaceholder),
                Sn.appendChild(Bn),
                nn(Sn);
              break;
            case "textarea":
              var Pn = G(P, o.textarea);
              (Pn.value = s.inputValue),
                (Pn.placeholder = s.inputPlaceholder),
                nn(Pn);
              break;
            case null:
              break;
          ...
          ("select" !== s.input && "radio" !== s.input) ||
            ...
            (mn = E()),
            (bn = L()),
            null !== dn && "function" == typeof dn && dn(bn),
            un ? (F(bn, o.show), F(mn, o.fade), J(bn, o.hide)) : J(bn, o.fade),
            nn(bn),
            (mn.style.overflowY = "hidden"),
            sn && !K(bn, o.noanimation)
              ? bn.addEventListener(sn, function n() {
                  bn.removeEventListener(sn, n), (mn.style.overflowY = "auto");
                })
              : (mn.style.overflowY = "auto"),
            F([document.documentElement, document.body, mn], o.shown),
            $() && (y(), v()),
  ...
  (C.isVisible = function () {
    ...
    (C.close = C.closePopup = C.closeModal = C.closeToast = function (n) {
      ...
      if (e) {
        ...
        sn && !K(e, o.noanimation)
          ? e.addEventListener(sn, function n() {
    ...
    (C.setDefaults = function (n) {
      if (!n || "object" !== (void 0 === n ? "undefined" : u(n)))
        return l(
    ...
    "undefined" != typeof window &&
      "object" === u(window._swalDefaults) &&
      C.setDefaults(window._swalDefaults);
  var S = { previousActiveElement: null, previousBodyPadding: null },
    A = function () {
    ...
    O = function () {
      return z(o.progresssteps);
    },
    Y = function () {
      return z(o.validationerror);
    },
    R = function () {
      return z(o.confirm);
    },
    ...
    G = function (n, t) {
      for (var e = 0; e < n.childNodes.length; e++)
        if (K(n.childNodes[e], t)) return n.childNodes[e];
    },
    nn = function (n) {
      (n.style.opacity = ""),
...
var BootstrapSelect = (function () {
  ...
  var ultimos_ingresos = function () {
    $.ajax({
      url: "assets/snippets/pages/user/ultimos_ingresos.php",
      method: "POST",
      dataType: "html",
    }).done(function (data) {
      $("#ultimos_ingresos").html(data);
    });
  };
